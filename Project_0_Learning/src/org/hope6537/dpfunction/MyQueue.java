...
/**
 * @Describe 带迭代器的使用链式存储结构的队列，由双链表类改编而成
 * @Author Hope6537(赵鹏)
 * @Signdate 2014年5月9日10:57:06
 * @version 0.9
 * @company Changchun University&SHXT
 */
@SuppressWarnings("hiding")
public class MyQueue<Object> implements Iterable<Object> {
