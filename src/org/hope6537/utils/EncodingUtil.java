...
import org.hope6537.thinking_in_java.eighteen.Directory;
...
public class EncodingUtil {
	...
	public static void main(String[] args) {
		try {
			...
			stringBuilder
					.append("E:\\(WorkSpace04)GitHub\\Project_00_Learning\\Project_0_Learning\\src\\org\\hope6537\\");
			TreeInfo tree = Directory.walk(stringBuilder.append(
					"hdoj_2000_2065").toString());
